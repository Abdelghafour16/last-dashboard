...
- Install deps: `npm i`
- Start dev: `npm start`
- The dashboard now includes an MQTT widget (topic editable). It connects using `VITE_MQTT_URL`.
...
- WebSocket Broker: `ws://localhost:8083/mqtt`

To test, publish from EMQX dashboard or any client to `test/topic` and see messages in the widget.